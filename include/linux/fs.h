...
struct file_operations {
	...
	__poll_t (*poll) (struct file *, struct poll_table_struct *);		// 查询设备是否可以立即读写，该方法主要用于阻塞性I/O操作
	long (*unlocked_ioctl) (struct file *, unsigned int, unsigned long);	// 提供与设备相关的控制命令的实现
	long (*compat_ioctl) (struct file *, unsigned int, unsigned long);		// 提供与设备相关的控制命令的实现
	...
	int (*fsync) (struct file *, loff_t, loff_t, int datasync);			// 实现了一种称为异步通知的特性
